...
type ConductivityChartProps = {
  data: ConductivityDataItem[];
};

export function ConductivityChart({ data }: ConductivityChartProps) {
    ...
    <Card className="@container/card">
      <CardHeader>
        ...
        <CardDescription>
          ...
          <span className="@[540px]/card:hidden">Daily Conductivity</span>
        </CardDescription>
        <CardAction>
      ...
      <CardContent className="px-2 pt-4 sm:px-6 sm:pt-6">
        ...
        >
          <AreaChart data={filteredData}>
            <defs>
              <linearGradient id="fillConductivity" x1="0" y1="0" x2="0" y2="1">
                <stop
                  offset="5%"
                  stopColor="var(--color-conductivity)"
                  stopOpacity={1.0}
                />
                <stop
                  offset="95%"
